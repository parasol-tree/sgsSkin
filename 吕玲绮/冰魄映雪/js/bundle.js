(function () {
  ...
  class SgsSkinViewerSkel {
      constructor() {
          ...
          this.audioElement_1 = new Audio("https://sgsimg.netlify.app/吕玲绮/冰魄映雪/LvLingQi_GuoWu_01.mp3");
          this.audioElement_2 = new Audio("https://sgsimg.netlify.app/吕玲绮/冰魄映雪/LvLingQi_GuoWu_02.mp3");
          this.audioElement_3 = new Audio("https://sgsimg.netlify.app/吕玲绮/冰魄映雪/LvLingQi_ShenWei_01.mp3");
          this.audioElement_4 = new Audio("https://sgsimg.netlify.app/吕玲绮/冰魄映雪/LvLingQi_ShenWei_02.mp3");
          this.audioElement_5 = new Audio("https://sgsimg.netlify.app/吕玲绮/冰魄映雪/LvLingQi_WuShuang_01.mp3");
          this.audioElement_6 = new Audio("https://sgsimg.netlify.app/吕玲绮/冰魄映雪/LvLingQi_WuShuang_02.mp3");
          this.audioElement_7 = new Audio("https://sgsimg.netlify.app/吕玲绮/冰魄映雪/LvLingQi_ZhuangRong_01.mp3");
          this.audioElement_8 = new Audio("https://sgsimg.netlify.app/吕玲绮/冰魄映雪/LvLingQi_ZhuangRong_02.mp3");
          this.setup();
      }
      setup() {
          this.path_list_init();
      ...
      onClick(e) {
          var number = this.getRandomIntBetweenXAndY(1, 8);
      ...
      path_list_init() {
          this.path_list_index = 0;
          this.path_list = [
              "https://sgsimg.netlify.app/吕玲绮/冰魄映雪/"
          ];
      }
  }
