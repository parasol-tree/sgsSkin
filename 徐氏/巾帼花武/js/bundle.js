(function () {
  ...
  class SgsSkinViewer {
      constructor() {
          ...
          this.audioElement_1 = new Audio("https://sgsimg.netlify.app/徐氏/巾帼花武/XuShi_FuZhu_1.mp3");
          this.audioElement_2 = new Audio("https://sgsimg.netlify.app/徐氏/巾帼花武/XuShi_FuZhu_2.mp3");
          this.audioElement_3 = new Audio("https://sgsimg.netlify.app/徐氏/巾帼花武/XuShi_WenGua_1.mp3");
          this.audioElement_4 = new Audio("https://sgsimg.netlify.app/徐氏/巾帼花武/XuShi_WenGua_2.mp3");
          this.setup();
      }
      ...
      play() {
          console.log('%c [ play ]-232', 'font-size:13px; background:skyblue; color:#fff;');
      ...
      path_list_init() {
          ...
          this.ani_index = 0;
          this.path_list = [
              "https://sgsimg.netlify.app/徐氏/巾帼花武/"
          ];
      }
  }
  new SgsSkinViewer();
