(function () {
  ...
  class SgsSkinViewerSkel {
      constructor() {
          ...
          this.audioElement_1 = new Audio("https://sgsimg.netlify.app/段巧笑/姝丽风华/DuanQiaoXiao_HuaYi_01.mp3");
          this.audioElement_2 = new Audio("https://sgsimg.netlify.app/段巧笑/姝丽风华/DuanQiaoXiao_HuaYi_02.mp3");
          this.audioElement_3 = new Audio("https://sgsimg.netlify.app/段巧笑/姝丽风华/DuanQiaoXiao_CaiZhuang_01.mp3");
          this.audioElement_4 = new Audio("https://sgsimg.netlify.app/段巧笑/姝丽风华/DuanQiaoXiao_CaiZhuang_02.mp3");
          this.setup();
      }
      setup() {
          this.path_list_init();
      ...
      path_list_init() {
          this.path_list_index = 0;
          this.path_list = [
              "https://sgsimg.netlify.app/段巧笑/姝丽风华/"
          ];
      }
  }
