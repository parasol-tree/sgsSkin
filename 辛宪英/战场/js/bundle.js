(function () {
  ...
  class SgsSkinViewerSkel {
      constructor() {
          ...
          this.audioElement_1 = new Audio("https://sgsimg.netlify.app/辛宪英/战场/XinXianYing_CaiShi_01.mp3");
          this.audioElement_2 = new Audio("https://sgsimg.netlify.app/辛宪英/战场/XinXianYing_CaiShi_02.mp3");
          this.audioElement_3 = new Audio("https://sgsimg.netlify.app/辛宪英/战场/XinXianYing_ZhongJian_01.mp3");
          this.audioElement_4 = new Audio("https://sgsimg.netlify.app/辛宪英/战场/XinXianYing_ZhongJian_02.mp3");
          this.setup();
      }
      setup() {
          this.path_list_init();
      ...
      path_list_init() {
          this.path_list_index = 0;
          this.path_list = [
              "https://sgsimg.netlify.app/辛宪英/战场/"
          ];
      }
  }
